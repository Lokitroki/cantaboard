        ...
        <main className='min-h-screen flex items-center justify-center px-4 bg-gray-100'>
            ...
            <div className='bg-white w-full max-w-md rounded-xl border p-6 shadow-sm space-y-6'>
                ...
                <form action="" className='space-y-6'>
                    ...
                    <input type="password" id='password' className='w-full border rounded px-3 py-2'/>

                    <button type='submit' className='w-full bg-black text-white rounded px-4 py-2 hover:bg-gray-800 transition duration-200'>Register</button>
                </form>
